...
The `StakeAtRisk` contract which manages staking NRNs for fighters during a duel needs to be set as you would expect to facilitate that very task when a round ensues.
